    ...
    if 'ole' in item and item['ole'] is not None:
        ...
        if 'thumbnail' in ole and ole['thumbnail'] is not None:
            try:
                ...
                item['ole']['thumbnail'] = base64.b64encode(ole['thumbnail'].encode('latin-1')).decode('ascii')
...
def main(argv=None) -> None:
    ...
    parser.add_argument('--utility_id', required=True, help='Utility company ID, which is a short, unique string LLNL uses')
